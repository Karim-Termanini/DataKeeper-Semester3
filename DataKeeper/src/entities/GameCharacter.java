...
/**
 * Abstrakte Basisklasse für Spielfiguren (Spieler und Gegner). Enthält gemeinsame
 * Animationlogik, Ausrichtung, Position und Lebensstatus.
 */
public abstract class GameCharacter implements Character {
    ...
    protected float x, y; // World coordinates
    ...
    public void render(Graphics g) {
        // Use screenX and screenY for rendering
        // Subclasses should override and use getScreenX(), getScreenY()
    }
    ...
    /**
     * Liefert die aktuelle Trefferbox (Hitbox) in Weltkoordinaten für Kollisionen.
     * @return Rechteckige Hitbox
     */
