...
/**
 * Zentrale, schreibgeschützte Spielkonstanten (Größen, Geschwindigkeiten, Timings u. ä.).
 * Strukturierte Unterklassen für Spieler-/Gegnerwerte und Aktionen.
 */
public class Constants {
    ...
    // Performance
    public static final int MAX_ACTIVE_ENEMIES = 16;
    public static final int ENEMY_DESPAWN_DISTANCE = 2000;
    ...
    public static class Player {
        ...
        // Damage bonus tuning
        public static final int DAMAGE_BONUS_BASE = 10; // +10 now
    public static final int DAMAGE_BONUS_PER_LEVEL = 5; // +5 per next level
    ...
    public static final int COMBO_TIME_WINDOW_MS = 900;
    }
    ...
    // Camera
    public static final int CAMERA_OFFSET_X = 900; // Adjusted to center the player (screenWidth/2 = 1800/2 = 900)
    public static final int CAMERA_OFFSET_Y = 300;
    public static final boolean ENABLE_SMOOTH_CAMERA = true;
    public static final float CAMERA_SMOOTHING = 0.15f; // 0..1
    public static final boolean ENABLE_SCREEN_SHAKE = true;
    public static final int SHAKE_FRAMES_HIT = 10;
    public static final int SHAKE_MAGNITUDE_HIT = 6;
    public static final int SHAKE_FRAMES_ATTACK = 6;
    public static final int SHAKE_MAGNITUDE_ATTACK = 3;
